...
map(
    'n',
    '<Leader>f',
    [[<Cmd>lua require('telescope.builtin').current_buffer_fuzzy_find({skip_empty_lines = true})<CR>]],cmd_options
)
...
map('n', '<Leader>9', [[<Cmd>lua require'dapui'.float_element("scope")<CR>]], cmd_options)
