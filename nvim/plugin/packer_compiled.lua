...
_G.packer_plugins = {
  ...
  cmp_luasnip = {
    loaded = true,
    path = "/Users/hglong/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
  ...
  ["targets.nvim"] = {
    loaded = true,
    path = "/Users/hglong/.local/share/nvim/site/pack/packer/start/targets.nvim",
    url = "https://github.com/wellle/targets.nvim"
  },
